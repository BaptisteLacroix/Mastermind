...
def verification(combinaisonIA,combinaisonJC):
    ...
    if combinaisonJC == combinaisonIA:
        ...
        for i in range(4):
            ...
            elif combinaisonJC[i] in combinaisonIA and combinaisonJC[i] not in listeNoir and combinaisonIA.count(combinaisonJC[i]) > listeBlanc.count(combinaisonJC[i]) + listeNoir.count(combinaisonJC[i]) + 1:
